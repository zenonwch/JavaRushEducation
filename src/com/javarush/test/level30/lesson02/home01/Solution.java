...
public class Solution {
	...
	public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
		int curBase = number.getNumerationSystem().getNumerationSystemIntValue();
		int expBase = expectedNumerationSystem.getNumerationSystemIntValue();
		return new Number(expectedNumerationSystem, new BigInteger(number.getDigit(), curBase).toString(expBase));
	}
}
