...
public class Solution {
	...
	public Item getProxy(Class<?> loader, Class<?>... interfaces) {
		ItemInvocationHandler iih = new ItemInvocationHandler();
		int len = interfaces.length;
		Class[] extendedI = new Class[len + 1];
		System.arraycopy(interfaces, 0, extendedI, 0, len);
		extendedI[len] = loader;
		return (Item) Proxy.newProxyInstance(loader.getClassLoader(), extendedI, iih);
	}
